  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label className="serviceNumber">Service Number:</label>
          <input type="text" id="serviceNumber" name="serviceNumber" value={formData.serviceNumber} onChange={handleChange} required />
        </div>
        <div>
